...
program ramses2gadget  
  ...
  real(kind=8), parameter :: kpc_in_cm = 3.08d24 ! the factor is from ramses: dont use more digits!
...
#ifdef LONGIDS
  integer (kind=8) :: npart, ngaspart, nramsespart, ndmpart, nstarpart, nsink, intdummy
  integer (kind=8) :: ngaspart_total, ndmpart_total, nstarpart_total
  integer(kind=8),dimension(:), allocatable :: gaspart_id,  ramsespart_id,  dmpart_id,  starpart_id
#else
...
!!! START UP AND GET PARAMETERS FROM FILES !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  write (*,*) 'Using dir_number ', dir_number
  !dir_number='00010' 
...
!!! SET UP SOME MORE PARAMETERS, DO SOME CHECKING !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  if (verbose) write(*,*) 'boxlen = ', boxsize
...
!!! READING DM + STAR PARTICLES !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
     ...
     if (verbose) write(*,*) 'gas = ', gas, ' nstarpart = ', nstarpart
...
!!! WRITE DATA INTO OUTPUT FILE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
     ...
     if (gas) then
	   ...
	   ! >> [ RF ]
	   ! write header block:
     ! ramses dark matter mass = 
           write(output_file) &
                &  ngaspart, ndmpart, 0_4, 0_4, nstarpart, 0_4,          & ! npart[6]
                &  0.0d0, 0.0d0, 0.0d0, 0.0d0, 0.0d0, 0.0d0,             & ! massarr[6]
                !&  0.0d0, 0.000054827d0, 0.0d0, 0.0d0, 0.0d0, 0.0d0,             & ! massarr[6]
                &  a, (1/a - 1d0), flagsfr, 0_4,                         & ! a, z, flagsfr, flagfeedback                 
                &  666_4, 777_4, 0_4, 0_4, 888_4, 0_4,                   & ! nall[6] - see comment above
                &  0_4, nfiles, boxsize, omega_m, omega_l, H0, 0_4, 0_4, & ! flagcooling ... flagmetals
                &  0_4, 0_4, 0_4, 0_4, 0_4, 0_4,                         & ! nallhighw[6]
  ...
  call MPI_ALLREDUCE(ngaspart_total,mpi_reduce_buffer, &
       & 1,MPI_INTEGER8,MPI_SUM,MPI_COMM_WORLD,mpi_ierr)
